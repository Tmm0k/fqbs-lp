    ...
    return (
        <section className="py-16 px-4">
            <div className="container mx-auto max-w-3xl">
                <h1 className="text-[42px] leading-[48px] font-bold mb-4">
                    Filaquin™ Anal Gland Supplement For Dogs
                </h1>

                <h2 className="text-[32px] leading-[40px] text-gray-700 mb-12">
                    Count: 132 Soft Chews
                </h2>

                <ul className="space-y-8">
                    <li className="text-[24px] leading-[32px] text-gray-600">
